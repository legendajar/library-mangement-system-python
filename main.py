...
class Main(object):
    def __init__(self,master):
        ...
        self.btn_search=Button(search_bar, text='Search',font='arial 12 bold', bg='#fcc324',fg='white',command=self.searchBooks)
        ...
        self.btngive = Button(topFrame, text='Add Book', font="Arial 12 bold", padx=10, image=self.iconbook, compound=LEFT, command=self.addBook)
        self.btngive.pack(side=LEFT)
        
        # add member button        
        self.iconmember = PhotoImage(file="Image/user.png")
        self.btnmember = Button(topFrame,text='Add Member',font='arial 12 bold',padx=10,image=self.iconmember,compound=LEFT,command=self.addMember)
        ...
        self.tabs.pack()
        self.tab1_icon=PhotoImage(file='Image/book.png')
        self.tab2_icon=PhotoImage(file='Image/user.png')
        ...
        self.lbl_book_count=Label(self.tab2, text="Harsh Solanki",pady=20,font='verdana 14 bold')
        self.lbl_book_count.grid(row=0)
        self.lbl_member_count=Label(self.tab2,text="Harsh Solanki",pady=20,font='verdana 14 bold')
        self.lbl_member_count.grid(row=1,sticky=W)
        self.lbl_taken_count=Label(self.tab2,text='Harsh Solanki',pady=20,font='verdana 14 bold')
...
class GiveBook(Toplevel):
    def __init__(self):
        ...
        self.lbl_phone=Label(self.bottomFrame,text='Memeber: ',font='arial 15 bold',fg='white',bg='#fcc324')
    ...
    def lendBook(self):
        ...
        if book_name and member_name != "":
            ...
            messagebox.showerror("Error", "Fields Can't be emppty", icon = 'warning')
